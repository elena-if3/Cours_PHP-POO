...
class Passeport
{
    ...
    public function __construct(string $numero = "XY0000000", DateTime $dateFinValidite = (new DateTime()))
    {
        $this->numero = $numero;
    ...
    {
        print("<h6>Numéro: " . $this->numero . "<br/>Date de fin validité: " . $this->dateFinValidite->format("Y-m-d") . "</h6>");
    }
}
